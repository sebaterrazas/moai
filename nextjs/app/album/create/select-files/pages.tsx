...
/*   let ceilingNumber = Math.ceil(files.length / 3);
  let newList = Array.from(Array(ceilingNumber).keys()); */

  return (
    <form
      className={'flex flex-col items-start justify-start text-foreground w-full h-dvh py-3 max-h-screen'}
